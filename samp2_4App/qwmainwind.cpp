...
void QWMainWind::on_Aboutaction_triggered()
{
    ...
    info->setWindowTitle("About");
     ...
     // 创建 QLabel
     QLabel *label = new QLabel("黄金海 2022414040216");
     label->setAlignment(Qt::AlignCenter); // 设置文本居中

     // 创建 QPushButton
     QPushButton *button = new QPushButton("确认");
     QObject::connect(button, &QPushButton::clicked, info, &QWidget::deleteLater);
     // 将控件添加到布局中
